...
MODEL                   = MATLAB0
MODULES                 = MATLAB0_sf.c rtGetInf.c rtGetNaN.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\MATLAB0_sf.mexw64
MAKEFILE                = MATLAB0.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2023a
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2023a
START_DIR               = C:\Users\cesf9\ONEDRI~1\ROS_MA~1\LIDARS~1
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:MATLAB0_sf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SYSTEM_LIBS             = /LIBPATH:"C:\Program Files\MATLAB\R2023a\extern\lib\win64\microsoft" libut.lib libfixedpoint.lib libmx.lib libmex.lib
...
MODELLIB                  = MATLAB0_sf.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = MATLAB0_ref.rsp
COMPILER_COMMAND_FILE     = MATLAB0_comp.rsp
...
MATLAB0_sf.obj : $(START_DIR)\MATLAB0_sfcn_rtw\MATLAB0_sf.c
	@cmd /C "echo ### Compiling $(START_DIR)\MATLAB0_sfcn_rtw\MATLAB0_sf.c
	$(CC) $(CFLAGS) $(START_DIR)\MATLAB0_sfcn_rtw\MATLAB0_sf.c

rtGetInf.obj : $(START_DIR)\MATLAB0_sfcn_rtw\rtGetInf.c
	@cmd /C "echo ### Compiling $(START_DIR)\MATLAB0_sfcn_rtw\rtGetInf.c
	$(CC) $(CFLAGS) $(START_DIR)\MATLAB0_sfcn_rtw\rtGetInf.c

rtGetNaN.obj : $(START_DIR)\MATLAB0_sfcn_rtw\rtGetNaN.c
	@cmd /C "echo ### Compiling $(START_DIR)\MATLAB0_sfcn_rtw\rtGetNaN.c
	$(CC) $(CFLAGS) $(START_DIR)\MATLAB0_sfcn_rtw\rtGetNaN.c
