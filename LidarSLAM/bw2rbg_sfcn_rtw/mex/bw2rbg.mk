...
MODEL                   = bw2rbg
MODULES                 = bw2rbg_sf.c rtGetInf.c rtGetNaN.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\bw2rbg_sf.mexw64
MAKEFILE                = bw2rbg.mk
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:bw2rbg_sf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SYSTEM_LIBS             = /LIBPATH:"C:\Program Files\MATLAB\R2023b\extern\lib\win64\microsoft" libut.lib libfixedpoint.lib libmx.lib libmex.lib
...
MODELLIB                  = bw2rbg_sf.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = bw2rbg_ref.rsp
COMPILER_COMMAND_FILE     = bw2rbg_comp.rsp
...
bw2rbg_sf.obj : $(START_DIR)\bw2rbg_sfcn_rtw\bw2rbg_sf.c
	@cmd /C "echo ### Compiling $(START_DIR)\bw2rbg_sfcn_rtw\bw2rbg_sf.c
	$(CC) $(CFLAGS) $(START_DIR)\bw2rbg_sfcn_rtw\bw2rbg_sf.c

rtGetInf.obj : $(START_DIR)\bw2rbg_sfcn_rtw\rtGetInf.c
	@cmd /C "echo ### Compiling $(START_DIR)\bw2rbg_sfcn_rtw\rtGetInf.c
	$(CC) $(CFLAGS) $(START_DIR)\bw2rbg_sfcn_rtw\rtGetInf.c

rtGetNaN.obj : $(START_DIR)\bw2rbg_sfcn_rtw\rtGetNaN.c
	@cmd /C "echo ### Compiling $(START_DIR)\bw2rbg_sfcn_rtw\rtGetNaN.c
	$(CC) $(CFLAGS) $(START_DIR)\bw2rbg_sfcn_rtw\rtGetNaN.c
