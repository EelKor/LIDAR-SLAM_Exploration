...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_Turtle_RRT_Algorithm_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Turtle_RRT_Algorithm_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_Turtle_RRT_Algorithm_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "Turtle_RRT_Algorithm") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Turtle_RRT_Algorithm_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_Turtle_RRT_Algorithm_jit_fallback_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Turtle_RRT_Algorithm") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Turtle_RRT_Algorithm_jit_fallback_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_post_codegen_info_call( int nlhs, mxArray * plhs[],
  int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Turtle_RRT_Algorithm_get_post_codegen_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Turtle_RRT_Algorithm") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Turtle_RRT_Algorithm_get_post_codegen_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Turtle_RRT_Algorithm_updateBuildInfo_args_info( int
  ...
  if (strcmp(machineName, "Turtle_RRT_Algorithm") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Turtle_RRT_Algorithm_updateBuildInfo_args_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Turtle_RRT_Algorithm_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "Turtle_RRT_Algorithm") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Turtle_RRT_Algorithm_get_eml_resolved_functions_info(nlhs,plhs,3,
      newRhs);
  }
...
extern unsigned int sf_Turtle_RRT_Algorithm_method_dispatcher(SimStruct *S,
...
{
  if (!strcmp(machineName,"Turtle_RRT_Algorithm")) {
    return(sf_Turtle_RRT_Algorithm_method_dispatcher(simstructPtr,
...
extern void Turtle_RRT_Algorithm_terminator(void);
extern "C" void sf_machine_global_terminator(SimStruct* S)
{
  (void)S;
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    Turtle_RRT_Algorithm_terminator();
  }

  return;
}

extern void Turtle_RRT_Algorithm_initializer(void);
extern void Turtle_RRT_Algorithm_register_exported_symbols(SimStruct* S);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Turtle_RRT_Algorithm_register_exported_symbols(S);
}
...
extern "C" void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    Turtle_RRT_Algorithm_initializer();
  }
