...
MODEL     = Turtle_RRT_Algorithm
TARGET      = sfun
MODULE_SRCS   = c8_Turtle_RRT_Algorithm.cpp half_type.cpp
MODEL_SRC  = Turtle_RRT_Algorithm_sfun.cpp
MODEL_REG = Turtle_RRT_Algorithm_sfun_registry.cpp
MAKEFILE    = Turtle_RRT_Algorithm_sfun.mak
...
USER_INCLUDES   =  /I "C:\Users\cesf9\onedrive - 충남대학교\ros_matlab\lidarslam\slprj\_sfprj\turtle_rrt_algorithm\_self\sfun\src" /I "C:\Users\cesf9\onedrive - 충남대학교\ros_matlab\lidarslam"
AUX_INCLUDES   = 
MLSLSF_INCLUDES = \
    ...
    /I "C:\Users\cesf9\OneDrive - 충남대학교\ROS_MATLAB\LidarSLAM\slprj\_sfprj\Turtle_RRT_Algorithm\_self\sfun\src" 
...
OBJLIST_FILE = Turtle_RRT_Algorithm_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
