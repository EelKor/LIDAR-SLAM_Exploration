...
MODEL     = Lidar_Slam_Sim
TARGET      = sfun
MODULE_SRCS   = c2_Lidar_Slam_Sim.c half_type.c
MODEL_SRC  = Lidar_Slam_Sim_sfun.c
MODEL_REG = Lidar_Slam_Sim_sfun_registry.c
MAKEFILE    = Lidar_Slam_Sim_sfun.mak
...
USER_INCLUDES   =  /I "C:\Users\\onedrive - \ros_matlab\slprj\_sfprj\lidar_slam_sim\_self\sfun\src" /I "C:\Users\\onedrive - \ros_matlab"
AUX_INCLUDES   = 
MLSLSF_INCLUDES = \
    ...
    /I "C:\Users\\OneDrive - \ROS_MATLAB\slprj\_sfprj\Lidar_Slam_Sim\_self\sfun\src" 
...
OBJLIST_FILE = Lidar_Slam_Sim_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
