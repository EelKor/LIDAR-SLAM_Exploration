#ifndef __Lidar_Slam_Sim_sfun_h__
#define __Lidar_Slam_Sim_sfun_h__
...
extern mxArray* load_Lidar_Slam_Sim_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_Lidar_Slam_Sim_optimization_info(void);
